...
{{< perex >}} Whether you have an iguana, turtle, snake or gecko, you definitely want them to be as comfortable as possible at home. 👌🦎 Monitor the climate in their terrarium and make sure your green buddy has ideal living conditions. {{< /perex >}}
...
If you already have the Starter Kit, you will only need the [Climate Module](https://obchod.bigclown.cz/climate-module/). Alternatively, the [Climate Monitor Kit](https://obchod.bigclown.cz/climate-monitor-kit/) contains **all the equipment** you need.

{{< modules >}}

## Prepare the box

1. Put the Climate Monitor Kit together and pair it. If you are doing this for the first time, [we've prepared a simple guide for you](https://www.bigclown.com/cs/handbook/) \- the procedure is the same as for the Starter Kit. You need the **radio climate monitor** firmware for the Core Module. If you don't know how to download the firmware or what it is,[you can find out here](https://www.bigclown.com/cs/academy/jak-nahrat-firmware/).
