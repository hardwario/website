...
<div class = "row align-items-start">
    ...
    <div class = "col-md-8">
        <p>Node <strong>Notify</strong> node has a clear mission - to send a notification to a mobile. It will be displayed in the Blynk app. [Blynk]({{< ref "/tower/tutorials/how-to-connect-blynk-iot.en.md" >}}).</p>
    </div>
</div>
...
[Check them out]({{< ref "/tower/projects/_index.en.md" >}})
