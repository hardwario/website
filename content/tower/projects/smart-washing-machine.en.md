...
1. If you haven’t done it yet, [put together]({{< ref "/tower/tutorials/handbook.en.md" >}}) the Starter Kit.
...
**Our tip:** If you don’t know how to download the firmware or what it is, [you will find out here]({{< ref "/tower/tutorials/how-to-flash-firmware.en.md" >}}).

3. [Pair the Core Module with the USB Dongle]({{< ref "/tower/tutorials/how-to-pair-kit.en.md" >}}). Right after pairing it, you will see that your Core Module changed Alias to **washing-machine-detector**. 👌
...
1. In the Playground, click on the **Functions tab**, where the [Node-RED]({{< ref "/tower/tutorials/what-is-node-red.en.md" >}}) programming desktop is located. 🤖
...
1. It’s time to steal your mom’s or dad’s mobile and set up their own Blynk. If you don’t know how to do it yet, [**check out the instructions**]({{< ref "/tower/tutorials/how-to-connect-blynk-iot.en.md" >}}).
