...
3. [Pair the Core Module with the USB Dongle]({{< ref "/tower/tutorials/how-to-pair-kit.en.md" >}}). Right after pairing it, you will notice that your Core Module has changed Alias to **x-axis-detector**.
