...
1. Set your own indicator to record the lowest or highest temperature. On your computer, start with the bubbles in the [Node-RED]({{< ref "/education/tutorials/what-is-node-red.en.md" >}}). First, click on the **Functions** tab in the Playground.
