...
1. Pokud to ještě nemáš, Starter Kit [sestav]({{< ref "/education/tutorials/handbook.en.md" >}}).
...
**Náš tip:** Nevíš, jak si firmware stáhnout nebo co to je? [Zjistíš to tady]({{< ref "/education/tutorials/how-to-flash-firmware.en.md" >}}).

3. [Core Module spáruj s USB Donglem]({{< ref "/education/tutorials/how-to-pair-kit.en.md" >}}). Hned po spárování uvidíš, že tvůj Core Module změnil Alias na **x-axis-detector**.
