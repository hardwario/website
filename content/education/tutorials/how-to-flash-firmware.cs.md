...
**Jaký firmware potřebuješ, najdeš napsané vždycky u** [**konkrétního projektu**]({{< ref "/education/projects/_index.cs.md" >}}). 🤙
...
A teď ti už jen zbývá [spárovat Dongle s Core modulem]({{< ref "/education/tutorials/how-to-pair-kit.cs.md" >}}), jako obvykle.
